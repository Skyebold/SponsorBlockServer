...
import { ActionType, Category, VideoDBSegment } from "../types/videoSegments.model";
...
function getSegmentsFromDBByVideoID(videoID: VideoID, service: Service): Promise<VideoDBSegment[]> {
    return db.prepare(
        "all",
...
function filterSegments(segments: VideoDBSegment[], page: number, filters: Record<string, any>) {
